...
const scheduleScreenshot = "/screens/schedule-view.png";
const paymentScreenshot = "/screens/payment-processing.png";
const clientScreenshot = "/screens/ai-assistant.png";
